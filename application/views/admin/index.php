            ...
            <div class="col-md-8">
                <div class="card card-primary card-outline">
                    <div class="card-header ">
                        <h6 class="m-0 font-weight-bold">Activity <a href="<?php echo base_url('admin/reset/' . $user['id_user']); ?>" class="tombol-reset btn btn-secondary btn-sm float-right"><i class="fa fa-spinner"></i> Reset Activity</a></h6>
                    </div>
                    <div class="card-body">
