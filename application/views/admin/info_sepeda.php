            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/mst_sepeda'); ?>" class="btn btn-info btn-sm">Kembali</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Jumlah Sepeda</b> <a class="float-right"><?php echo $detail['jml_sepeda']; ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>Harga Sewa</b> <a class="float-right">Rp. <?php echo rupiah($detail['harga_sewa']); ?> / Jam</a>
                            </li>
                        </ul>
                    </div>
                </div>
